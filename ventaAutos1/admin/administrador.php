...
?>
    ...
    <main class="contenedor seccion">
        ...
        <a href="/ventaAutos1/admin/administrador/crear.php" class="boton boton-verde">Registrar nuevo auto</a>
        <a href="/ventaAutos1/admin/administrador/empleados.php" class="boton boton-verde">Empleados</a>
            ...
            <tbody>
                ...
                <?php while ($auto = mysqli_fetch_assoc($resultadoConsulta)) : ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <br>
                            <a style="border-radius: 1rem" href="/ventaAutos1/admin/administrador/actualizar.php?id=<?php echo $auto['id'];  ?>" class="boton-amarillo-block">Actualizar</a>
