    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST'){
        ...
        if(empty($errores)){
            ...
            if($resultado){
                ...
                header('Location: /ventaAutos1/admin/administrador.php?resultado=1');
            }
...
?>
    ...
    <main class="contenedor seccion">
        ...
        <form class="formulario" method="POST", action="/ventaAutos1/admin/administrador/crear.php" enctype="multipart/form-data">
            <fieldset>
